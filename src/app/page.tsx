              ...
              <div className="flex flex-col w-80 items-center justify-center gap-3 px-6 py-6">
                ...
                {showCongratsModal && (
                  <div className="fixed inset-0 flex items-center justify-center z-50">
                    <div className="fixed inset-0 bg-black opacity-50" onClick={closeCongratsModal}></div>
                    <div className="bg-white rounded-lg p-6 max-w-sm w-full mx-4 z-10 relative">
                      <button 
                      ...
                      <div className="text-center">
                        ...
                        <button
                          onClick={closeCongratsModal}
                          className="mt-4 bg-[#418FDE] hover:bg-[#2e7bc4] text-white font-medium py-2 px-6 rounded-md transition-colors"
                        >
                          Close
                        </button>
                      </div>
